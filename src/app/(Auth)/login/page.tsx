...
if(error){toast.error(error.message)}
  ...
  return (
    <div className="flex flex-col items-center mt-5 md:mt-3 mb-3  md:justify-center">
      ...
      <form onSubmit={handleSubmit(onsubmit)} className="flex flex-col mt-5 w-[90%] md:w-[360px] md:mt-0">
         <button className="bg-[#F5F5F5] rounded text-[#717171] pt-2 pb-2 font-light text-sm hover:opacity-50 border border-[#C7C6C6] md:pt-2 md:pb-2 md:text-base transition-colors disabled:opacity-50  mt-7 mb-9" onClick={oauth}>Continue with google</button>
